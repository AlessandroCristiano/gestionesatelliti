				                	...
				                	<c:forEach items="${satellite_list_attribute }" var="satelliteItem">
										<tr>
											...
											<td>
												...
												<div class="btn-group">
													<div>
														<c:if test="${satelliteItem.dataLancio == null and satelliteItem.stato == null}">
															<form method="post" action="${pageContext.request.contextPath}/satellite/launch">
																<button type="submit" name="submit" value="submit" id="submit" class="btn btn-outline-primary btn-sm">Launch</button>
																<input type="hidden" name="idSatellite" value="${satelliteItem.id}">
															</form>
														</c:if>
														<c:if test="${satelliteItem.dataRientro == null and satelliteItem.stato == 'FISSO' and satelliteItem.dataLancio != null}">
